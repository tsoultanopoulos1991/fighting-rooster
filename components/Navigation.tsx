...
export default function Navigation() {
  ...
  return (
    <nav className={`fixed w-full z-50 transition-all duration-300 ${
      scrolled 
        ? 'bg-white shadow-lg py-2 backdrop-blur-md' 
        ...
        <div className="flex justify-between items-center">
          ...
          <div className={`flex items-center space-x-2 md:space-x-3 transition-all duration-300`}>
            ...
            <div className={`transition-all duration-300 ${
              ...
              <div className={`w-full h-full bg-primary-300 rounded-full flex items-center justify-center transition-all duration-300 ${
            ...
            {/* Text Logo - Smaller */}
            <div className={`font-display font-bold transition-all duration-300 ${
              scrolled 
              ...
              <div className={`text-xs font-normal tracking-wider opacity-90 ${
